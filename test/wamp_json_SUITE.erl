...
test_float(_) ->
    ...
    ?assertEqual(<<"1.0">>, wamp_json:encode(1.0)),
    ?assertEqual(<<"1.01">>, wamp_json:encode(1.01)),
    ?assertEqual(<<"1.012">>, wamp_json:encode(1.012)),
    ?assertEqual(<<"1.0123">>, wamp_json:encode(1.0123)),
    ?assertEqual(<<"1.0123">>, wamp_json:encode(1.01234)),

    Default = [{float_format, [{decimals, 4}, compact]}],
